<template>
  <el-dialog
    ...
    <el-form-item label="单选 多选[0 1]" prop="valueType">
      <el-input v-model="dataForm.valueType" placeholder="单选 多选[0 1]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          valueType: [
            { required: true, message: '单选 多选[0 1]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
